(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('./d3-SvgToWebgl')) :
    typeof define === 'function' && define.amd ? define('circos', ['exports', 'd3-SvgToWebgl'], factory) :
      (factory((global.Circos = global.Circos || {}), global.d3));
...
var Layout = function () {
  function Layout(conf, data) {
    ...
    this.conf = defaultsDeep_1(conf, cloneDeep_1(defaultConf$1));
    this.data = data;
    var agg = reduce_1(data, function (aggregator, block) {
    ...
    forEach_1(this.data, function (block, index) {
  ...
  createClass(Layout, [{
    ...
    value: function summary() {
      return reduce_1(this.data, function (summary, block) {
...
function renderLayoutLabels(conf, block) {
  ...
  var labelArc = arc().innerRadius(radius).outerRadius(radius).startAngle(function (d, i) {
    return d.start;
...
function renderLayoutTicks(conf, layout, instance) {
  ...
  function blockTicks(d) {
    ...
    return range(0, d.len, conf.ticks.spacing).map(function (v, i) {
      return {
        angle: v * k + d.start,
...
function renderLayout(parentElement, instance) {
  ...
  var layout = parentElement.append('g').attr('class', 'cs-layout item-wrapper').attr('z-index', conf.zIndex).on('click', conf.onClick);
  ...
  var entry = arc().innerRadius(conf.innerRadius).outerRadius(conf.outerRadius).cornerRadius(conf.cornerRadius).startAngle(function (d) {
    return d.start;
  }).endAngle(function (d) {
    return d.end;
  });
...
function render() {
  ...
  if (removeTracks) {
    forEach_1(circos.tracks, function (track, trackId) {
  ...
  var sortedTrackContainers = sortBy_1(trackContainers._groups[0], function (elt) {
...
function registerTooltip(track, instance, element, trackParams) {
  track.dispatch.on('mouseover', function (d) {
    instance.tip.html(trackParams.tooltipContent(d)).transition().style('opacity', 0.9).style('left', event$1.pageX + 'px').style('top', event$1.pageY - 28 + 'px');
  });
...
var assign = _createAssigner(function(object, source) {
  ...
  for (var key in source) {
    if (hasOwnProperty$13.call(source, key)) {
...
function getFuncName(func) {
  var result = (func.name + ''),
      ...
      length = hasOwnProperty$14.call(_realNames, result) ? array.length : 0;
...
function iteratee(func) {
  return _baseIteratee(typeof func == 'function' ? func : _baseClone(func, CLONE_DEEP_FLAG$4));
}
...
var func = convert_1('sortBy', sortBy_1);
...
var func$1 = convert_1('flow', flow_1);
...
var func$2 = convert_1('concat', concat_1);
...
var func$3 = convert_1('filter', filter_1);
...
var func$4 = convert_1('head', head_1, _falseOptions);
 ...
 * // => [3, 2, 1]
 */
function reverse$3(array) {
  return array == null ? array : nativeReverse.call(array);
}

var reverse_1 = reverse$3;

var func$5 = convert_1('reverse', reverse_1);

func$5.placeholder = placeholder;
var reverse$1 = func$5;
...
function smartBorders(conf, layout, tracks) {
  ...
  var externalTrack = flow(filter('conf.outerRadius'), sortBy$2('conf.outerRadius'), reverse$1, first)(concat(tracks, layout));
...
function buildScale(min, max, height) {
  ...
  var scale = logScale && min * max > 0 ? log().base(logScaleBase) : linear$2();
...
var buildConf = function buildConf() {
  ...
  var conf = {};
  forEach_1(defaultConf, function (item, key) {
    // if it's a leaf
...
var computeRadius = function computeRadius(conf, instance) {
  if (conf.innerRadius === 0 && conf.outerRadius === 0) {
    var borders = smartBorders(conf, instance._layout, instance.tracks);
    return {
...
var getConf = function getConf(userConf, defaultConf, meta, instance) {
  var conf = buildConf(userConf, cloneDeep_1(defaultConf));
  assign_1(conf, computeMinMax(conf, meta), computeRadius(conf, instance));
  return conf;
};
...
var buildColorScale = function buildColorScale(interpolator, min, max) {
  ...
  if (logScale && min * max > 0) {
    var scale = log().base(logScaleBase).domain(reverse ? [max, min] : [min, max]).range([0, 1]);
...
var _buildAxesData = function _buildAxesData(conf) {
  return reduce_1(conf.axes, function (aggregator, axesGroup) {
    ...
    if (axesGroup.spacing) {
      var builtAxes = range_1(axesGroup.start || conf.cmin, axesGroup.end || conf.cmax, axesGroup.spacing).map(function (value) {
...
var renderAxes = function renderAxes(parentElement, conf, instance, scale) {
  var axes = _buildAxesData(conf);

  var axis = arc().innerRadius(function (d) {
  ...
  createClass(Track, [{
    ...
    value: function renderBlock(parentElement, data, layout, conf) {
      ...
      if (conf.backgrounds) {
        ...
        }).attr('d', arc().innerRadius(function (background) {
...
function checkParent(key, index, layoutSummary, header) {
  if (!includes_1(keys_1(layoutSummary), key)) {
...
function checkNumber(keys, index) {
  return every_1(keys, function (value, header) {
    if (isNaN(value)) {
...
function buildOutput(data) {
  return {
    data: nest().key(function (datum) {
      return datum.block_id;
    }).entries(data),
    meta: {
      min: min$1(data, function (d) {
        return d.value;
      }),
      max: max$1(data, function (d) {
        return d.value;
      })
    }
  };
...
function parseChordData(data, layoutSummary) {
  ...
  return {
    data: formatedData,
    meta: {
      min: min$1(formatedData, function (d) {
        return d.value;
      }),
      max: max$1(formatedData, function (d) {
        return d.value;
      })
    }
  };
...
var Text = function (_Track) {
  inherits(Text, _Track);

  function Text(instance, conf, data) {
    classCallCheck(this, Text);
    return possibleConstructorReturn(this, (Text.__proto__ || Object.getPrototypeOf(Text)).call(this, instance, conf, defaultConf$2, data, parsePositionTextData));
  }
  ...
  createClass(Text, [{
    ...
    value: function renderDatum(parentElement, conf, layout) {
      ...
      forEach_1(conf.style, function (value, key) {
...
var Highlight = function (_Track) {
  inherits(Highlight, _Track);

  function Highlight(instance, conf, data) {
    classCallCheck(this, Highlight);
    return possibleConstructorReturn(this, (Highlight.__proto__ || Object.getPrototypeOf(Highlight)).call(this, instance, conf, defaultConf$3, data, parseSpanStringData));
  }
  ...
  createClass(Highlight, [{
    ...
    value: function renderDatum(parentElement, conf, layout) {
      ...
      return parentElement.selectAll('tile').data(function (d) {
        return d.values;
      }).enter().append('path').attr('class', 'tile').attr('d', arc().innerRadius(conf.innerRadius).outerRadius(conf.outerRadius).startAngle(function (d, i) {
...
}, axes, radial, common, values$3);

var Histogram = function (_Track) {
  inherits(Histogram, _Track);

  function Histogram(instance, conf, data) {
    classCallCheck(this, Histogram);
    return possibleConstructorReturn(this, (Histogram.__proto__ || Object.getPrototypeOf(Histogram)).call(this, instance, conf, defaultConf$4, data, parseSpanValueData));
  }

  createClass(Histogram, [{
    key: 'renderDatum',
    value: function renderDatum(parentElement, conf, layout) {
      var _this2 = this;
...
var ribbon = function() {
  ...
  ribbon.radius = function(_) {
    return arguments.length ? (radius = typeof _ === "function" ? _ : constant$7(+_), ribbon) : radius;
  };
...
var Chords = function (_Track) {
  inherits(Chords, _Track);

  function Chords(instance, conf, data) {
    classCallCheck(this, Chords);
    return possibleConstructorReturn(this, (Chords.__proto__ || Object.getPrototypeOf(Chords)).call(this, instance, conf, defaultConf$5, data, parseChordData));
  }
  ...
  createClass(Chords, [{
    ...
    value: function renderChords(parentElement, name, conf, data, instance, getCoordinates) {
      ...
      var link = track.selectAll('.chord').data(data).enter().append('path').attr('class', 'chord').attr('d', ribbon().source(function (d) {
...
}, radial, values$3, common);

var Heatmap = function (_Track) {
  inherits(Heatmap, _Track);

  function Heatmap(instance, conf, data) {
    classCallCheck(this, Heatmap);
    return possibleConstructorReturn(this, (Heatmap.__proto__ || Object.getPrototypeOf(Heatmap)).call(this, instance, conf, defaultConf$6, data, parseSpanValueData));
  }
  ...
  createClass(Heatmap, [{
    ...
    value: function renderDatum(parentElement, conf, layout) {
      ...
      return parentElement.selectAll('tile').data(function (d) {
        return d.values;
      }).enter().append('path').attr('class', 'tile').attr('opacity', conf.opacity).attr('d', arc().innerRadius(conf.innerRadius).outerRadius(conf.outerRadius).startAngle(function (d, i) {
        return _this2.theta(d.start, layout.blocks[d.block_id]);
      }).endAngle(function (d, i) {
        return _this2.theta(d.end, layout.blocks[d.block_id]);
...
var splitByGap = function splitByGap(points, maxGap) {
  return reduce_1(sortBy_1(points, 'position'), function (aggregator, datum) {
...
var Line = function (_Track) {
  inherits(Line, _Track);

  function Line(instance, conf, data) {
    classCallCheck(this, Line);
    return possibleConstructorReturn(this, (Line.__proto__ || Object.getPrototypeOf(Line)).call(this, instance, conf, defaultConf$7, data, parsePositionValueData));
  }
  ...
  createClass(Line, [{
    ...
    value: function renderDatum(parentElement, conf, layout) {
      ...
      var line = radialLine().angle(function (d) {
        return d.angle;
      }).radius(function (d) {
        return d.radius;
      }).curve(curveLinear);

      var area = radialArea().angle(function (d) {
        return d.angle;
...
var Scatter = function (_Track) {
  inherits(Scatter, _Track);

  function Scatter(instance, conf, data) {
    classCallCheck(this, Scatter);
    return possibleConstructorReturn(this, (Scatter.__proto__ || Object.getPrototypeOf(Scatter)).call(this, instance, conf, defaultConf$8, data, parsePositionValueData));
  }
...
}, axes, radial, values$3, common);

var Stack$2 = function (_Track) {
  inherits(Stack, _Track);

  function Stack(instance, conf, data) {
    classCallCheck(this, Stack);

    var _this = possibleConstructorReturn(this, (Stack.__proto__ || Object.getPrototypeOf(Stack)).call(this, instance, conf, defaultConf$9, data, parseSpanValueData));
  ...
  createClass(Stack, [{
    ...
    value: function buildLayers(data, margin) {
      forEach_1(data, function (block, idx) {
        ...
        var layers = [];
        forEach_1(block.values, function (datum) {
          var placed = false;
          forEach_1(layers, function (layer, i) {
            // try to place datum
    ...
    value: function renderDatum(parentElement, conf, layout) {
      ...
      }).enter().append('path').attr('class', 'tile').attr('d', arc()).attr('opacity', conf.opacity).attr('stroke-width', conf.strokeWidth).attr('stroke', conf.strokeColor).attr('fill', conf.colorValue);
    }
  }]);
  return Stack;
}(Track);
...
var initClipboard = function initClipboard(container) {
  var input = select(container).append('input').attr('class', 'circos-clipboard').attr('type', 'hidden');
...
var Core = function () {
  function Core(conf) {
    ...
    this.tracks = {};
    this._layout = null;
    this.conf = defaultsDeep_1(conf, defaultConf);
    var container = select(this.conf.container).append('div').style('position', 'relative');
    this.svg = container.append('svg');
    if (select('body').select('.circos-tooltip').empty()) {
      this.tip = select('body').append('div').attr('class', 'circos-tooltip').style('opacity', 0);
    } else {
  ...
  createClass(Core, [{
    ...
    value: function removeTracks(trackIds) {
      ...
      if (typeof trackIds === 'undefined') {
        map_1(this.tracks, function (track, id) {
      ...
      } else if (isArray_1(trackIds)) {
        forEach_1(trackIds, function (trackId) {
    ...
    value: function stack(id, data, conf) {
      this.tracks[id] = new Stack$2(this, conf, data);
      return this;
    }
  }, {
    key: 'text',
    ...
    key: 'render',
    value: function render$$1(ids, removeTracks) {
