(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-selection'), require('d3-collection'), require('d3-color'), require('d3-timer'), require('pixi.js')) :
        typeof define === 'function' && define.amd ? define('d3-svg2webgl', ['exports', 'd3-selection', 'd3-collection', 'd3-color', 'd3-timer', 'pixi.js'], factory) :
        (factory((global.d3 = global.d3 || {}), global.d3, global.d3, global.d3, global.d3, global.PIXI));
}(this, (function (exports, d3Selection, d3Collection, d3Color, d3Timer, PIXI) {
    'use strict';
    ...
    function draw(node, point) {
        ...
        if (drawer === false) return;
            ...
            transResult = getTrans(0, 0, 1, 1, trans);

            var graphic = new PIXI.Graphics();
            graphic.setTransform(transResult.x || 0, transResult.y || 0, transResult.sx || 1, transResult.sy || 1);
            content = graphic;
            ...
            fill = {
                ...
                alpha: node.getValue('fill-opacity') || 1
            };
    ...
    function redraw(node, point) {
        ...
        return function () {
            ...
            // renderer.clear();
            // if root node refresh flag is true, here remove all children from stage
            // if (node.refresh) {
            // node.stage.destroy({
            //     children: true
            // });
    ...
    var path$1 = function (node, graphic, stroke, fill, point) {
        ...
        if (path) {
            ...
            for (var i = 0; i < pathArr.length; i++) {
                var index = pathArr[i].search(/[MHV]/);
                if (index !== -1) {
    ...
    function parsePath(path) {
        // for d3 axis temporarily
        // for path M V H only
        return path.match(/[MVH]([ \d,\.-])+/g);
    }
