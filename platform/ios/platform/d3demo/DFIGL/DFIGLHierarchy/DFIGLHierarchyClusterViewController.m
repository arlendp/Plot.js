//
//  DFIGLHierarchyClusterViewController.m
//  DFI
//
...
#import "DFIGLHierarchyClusterViewController.h"
...
@interface DFIGLHierarchyClusterViewController ()
@property (nonatomic, strong) DFIHierarchyCluster *cluster;
@end

@implementation DFIGLHierarchyClusterViewController
...
- (void)viewDidLoad {
    ...
    [_cluster size:CGSizeMake(360, self.view.bounds.size.height / 2 - 40)];
    [_cluster loadRootNode:stratify.root];

    DFIGLHierarchyClusterView *clusterView = [[DFIGLHierarchyClusterView alloc] initWithFrame:self.view.bounds andCluster:_cluster];
